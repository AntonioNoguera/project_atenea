...
import 'package:proyect_atenea/src/data/repositories_implementations/file_repository_impl.dart';
...
import 'package:proyect_atenea/src/domain/repositories/file_repository.dart';
...
Future<void> setupLocator() async {
  ...
  locator.registerFactory(() => FirebaseStorage.instance);

  // Registro del DataSource de RED
  // [ USER ]
  locator.registerFactory<UserDataSource>(
      () => UserDataSource(locator<FirebaseFirestore>())); //DataSource
  locator.registerFactory<UserRepository>(
      () => UserRepositoryImpl(locator<UserDataSource>())); //Repositorio

  // [ SUBJECT ]
  locator.registerFactory<SubjectDataSource>(
      () => SubjectDataSource(locator<FirebaseFirestore>())); //DataSource
  locator.registerFactory<SubjectRepository>(
      () => SubjectRepositoryImpl(locator<SubjectDataSource>())); //Repositorio

  // [ ACADEMY ]
  locator.registerFactory<AcademyDataSource>(
      () => AcademyDataSource(locator<FirebaseFirestore>())); //DataSource
  locator.registerFactory<AcademyRepository>(
      () => AcademyRepositoryImpl(locator<AcademyDataSource>())); //Repositorio

  // [ DEPARTMENT ]
  locator.registerFactory<DepartmentDataSource>(
      () => DepartmentDataSource(locator<FirebaseFirestore>())); //DataSource
  locator.registerFactory<DepartmentRepository>(() =>
      DepartmentRepositoryImpl(locator<DepartmentDataSource>())); //Repositorio

// [ FILE ]
  locator.registerFactory<FileDataSource>(
      () => FileDataSource(locator<FirebaseFirestore>(), locator<FirebaseStorage>() )); //DataSource
 locator.registerFactory<FileRepository>(() =>
      FileRepositoryImpl( locator<FileDataSource>())); //Repositorio
...
// Registro de SessionLocalDataSource y SessionRepository
  locator.registerFactory<SessionLocalDataSource>(
    () => SessionLocalDataSource(locator<SharedPreferences>()),
  ); // DataSource
  locator.registerFactory<SessionRepository>(
    () => SessionRepositoryImpl(locator<SessionLocalDataSource>()),
  ); // Repository
  ...
  locator.registerFactory(
      () => GetAcademiesByDepartment(locator<AcademyRepository>()));
  ...
  // SESSION
  locator
      .registerFactory(() => LoadSessionUseCase(locator<SessionRepository>()));
  locator
      .registerFactory(() => SaveSessionUseCase(locator<SessionRepository>()));
  locator
      .registerFactory(() => ClearSessionUseCase(locator<SessionRepository>()));
  locator
      .registerFactory(() => HasSessionUseCase(locator<LoadSessionUseCase>()));
  locator.registerFactory(() => UpdateSessionTokenUseCase(
      locator<SaveSessionUseCase>(), locator<LoadSessionUseCase>()));
  locator.registerFactory(
      () => HasPermissionForUUIDUseCase(locator<LoadSessionUseCase>()));
  locator.registerFactory(() => UpdateSessionUseCase(
      locator<SaveSessionUseCase>(), locator<LoadSessionUseCase>()));

  // [DEPARTMENT]
  locator.registerFactory(
      () => GetDepartmentUseCase(locator<DepartmentRepository>()));
  locator.registerFactory(
      () => SaveDepartmentUseCase(locator<DepartmentRepository>()));
  locator.registerFactory(
      () => UpdateDepartmentUseCase(locator<DepartmentRepository>()));
  locator.registerFactory(
      () => DeleteDepartmentUseCase(locator<DepartmentRepository>()));
  locator.registerFactory(
      () => GetAllDepartmentsUseCase(locator<DepartmentRepository>()));
  ...
  locator.registerFactory(
      () => GetSubjectsByAcademyID(locator<SubjectRepository>()));

  // [FILE]
  locator.registerFactory(() => UploadFileUseCase(locator<FileRepository>()));
  locator.registerFactory(() => GetFilesUseCase(locator<FileRepository>()));
  locator.registerFactory(() => DeleteFileUseCase(locator<FileRepository>()));
  ...
  locator.registerFactory(() => FileProvider(
        uploadFileUseCase: locator<UploadFileUseCase>(),
        getFilesUseCase: locator<GetFilesUseCase>(),
        deleteFileUseCase: locator<DeleteFileUseCase>(),
      ));
}
