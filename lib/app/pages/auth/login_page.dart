...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AteneaScaffold(
        body: Padding(
      padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width * 0.05, vertical: 50.0),
      child: Column(children: [
        Text("Bienvenido de vuelta", textAlign: TextAlign.center, style: AppTextStyles.builder(color: AppColors.primaryColor, size: FontSizes.h1, weight: FontWeights.semibold)),
        ...
        const Spacer(),
        Text("¿Eres nuevo por acá?, ¡Regístrate!", textAlign: TextAlign.center, style: AppTextStyles.builder(color: AppColors.primaryColor, size: FontSizes.body2, weight: FontWeights.semibold)),
        const SizedBox(
          height: 10,
        ),
        AteneaButton(backgroundColor: AppColors.secondaryColor, text: "Regístrate", onPressed: () {}),
      ]),
    ));
  }
}
